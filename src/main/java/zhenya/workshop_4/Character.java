...
public class Character {
    ...
    private static final int HEALTH_MAXIMUM = 0;
...
//    - increase character level in accordance with level table from beginning of this task
    public void increaseExperience(int experiencePoints){
        ...
        System.out.println(this.nickname + " got " + experiencePoints + " experience points. Now experience is " + this.experience + " points");
        increaseLevel(this.experience/100);
    }
}
